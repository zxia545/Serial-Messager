...
ColumnControllerTxEventAckOrNotAckDict = {
    ...
    ColumnEventFromController.EVT_MANUAL_VALVE_INPOS: CommLonCmds.NonAcked,
...
class Integrated60EventFromController(IntEnum):
    ...
    # /* End of Comm events */
    EVT_BOTTLE_CHILL_ALARM = 106,
    EVT_BOTTLE_CHILL_TIMER = 107,
    EVT_DISP_READY = 108,
    EVT_SERVICE_COMMS_TX_DEFER_QUEUE_TIMER = 109,
    EVT_HEARTBEAT_TIMER = 110,
    # /* --------- Controller Events -------------------------------- */
    EVT_CYCLE_TIMER = 111,
    EVT_POWER_ON_DELAY = 112,
    EVT_MANUAL_UPDATE = 113,
    EVT_STATE_CHANGE = 114,
    EVT_UPDATE_PROCESS_VARS = 115,
    EVT_REQUIRE_ISENSE = 116,
    EVT_ABORT_ISENSE = 117,
    EVT_UPDATE_CONTROL = 118,
    # /** --------- Defrost Control Events ------------------------- **/
    EVT_DEFROST_START = 119,
    EVT_DEFROST_ABORT = 120,
    EVT_DEICE_FINISHED = 121,
    EVT_DEFROST_FINISH = 122,
    EVT_DELAY_FINISHED = 123,
    EVT_RESET_OR_BOOTLOAD_WAIT = 124,
    EVT_FROST_INGRESS_HIGH = 125,
    EVT_OFFCYCLE_DEFROST_START = 126,
    EVT_OFFCYCLE_DEFROST_FINISH = 127,
    # /** --------- Door Events ------------------------------------ **/
    EVT_DOOR_OPEN = 128,
    EVT_DOOR_CLOSE = 129,
    EVT_DOOR_ALARM = 130,
    EVT_DOOR_ALARM_OVER = 131,
    EVT_DOOR_TIMER_COUNT = 132,
    EVT_SEND_DOOR_COUNT = 133,
    EVT_RESET_DOOR_COUNT = 134,
    EVT_DOORS_ALL_CLOSED = 135,
    EVT_QUERY_DOOR_STATE = 136,
    EVT_DOOR_OPEN_DURATION = 137,
    EVENT_DOOR_OPEN_WARNING = 138,
    EVT_HARNESS_DETECT = 139,
    # /* --------- Fan Events -------------------------------- */
    EVT_FAN_SPEED = 140,
    EVT_FAN_TIMER_EXPIRED = 141,
    EVT_FAN_FEEDBACK = 142,
    # /* --------- Current Sense Events ---------------------- */
    EVT_ISENSE_REQUIRES_CONTROL = 143,
    EVT_ISENSE_REQUIRES_ON = 144,
    EVT_ISENSE_REQUIRES_OFF = 145,
    EVT_ISENSE_DOESNT_REQUIRE_CONTROL = 146,
    EVT_ISENSE_TIMER_EXPIRED = 147,
    EVT_ISENSE_HAS_CONTROL = 148,
    EVT_ISENSE_START = 149,
    # /* --------- Compressor Events ------------------------ */
    EVT_COMP_SPEED_CHANGE = 150,
    EVT_OVERRIDE_COMP_SPEED = 151,
    EVT_COMP_MIN_TIMER_EXPIRED = 152,
    EVT_COMP_OFF = 153,
    EVT_COMP_ON = 154,
    EVT_RESET_AVERAGE = 155,
    EVT_SEND_AVERAGE = 156,
    EVT_REFRIGERANT_INITIALISED = 157,
    # /* --------- Heater Events -------------------- */
    EVT_HEATER_ON = 158,
    EVT_HEATER_OFF = 159,
    ...
    EVT_HS_UPDATE = 161,
    EVT_HS_HEART_BEAT = 162,
    # /* --------- Audio Events ------------------------------- */
    EVT_AUDIO_ON = 163,
    EVT_AUDIO_OFF = 164,
    EVT_AUDIO_ENABLE = 165,
    EVT_AUDIO_DISABLE = 166,
    EVT_AUDIO_DONE = 167,
    EVT_AUDIO_MANUAL = 168,
    # /* --------- Solenoid Events -------------------------------- */
    EVT_SOL_ON = 169,
    EVT_SOL_OFF = 170,
    EVT_SOL_SWITCH_Q = 171,
    EVT_SOL_TIMEOUT = 172,
    # /* --------- Gearbox Events -------------------------------- */
    EVT_GEARBOX_ON = 173,
    EVT_GEARBOX_OFF = 174,
    EVT_GEARBOX_TIMER_EXPIRED = 175,
    EVT_GEARBOX_LMT_SW = 176,
    EVT_GEARBOX_I_STBL_TIMER_EXPIRED = 177,
    # /* --------- Icemaker Events -------------------------------- */
    EVT_ICEMAKER = 178,
    EVT_IM_TIMER_EXPIRED = 179,
    EVT_IM_HTR_TIMER_EXPIRED = 180,
    EVT_ICE_TRAY_TEMP_FAULT_TIMER_EXPIRED = 181,
    EVT_TRAY_FULL_ROTATION_TIMEOUT = 182,
    EVT_LOW_TEMP_INTEGRAL_TIMER_EXPIRED = 183,
    EVT_GEARBOX_I_HIGH = 184,
    EVT_SOL_I_HI = 185,
    EVT_ICEMAKER_NEXT_STATE = 186,
    EVT_IM_MANUAL_STATE_VAR_CHANGED = 187,
    EVT_ICEMAKER_DISPENSE = 188,
    EVT_ICEMAKER_FILL_TRAY_CHECK = 189,
    # /* --------- Water Dispenser Events -------------------------------- */
    EVT_DISPENSE = 190,
    EVT_DOOR_OPEN_DELAY = 191,
    EVT_WATER_DISPENSE_DOOR_CLOSE_DELAY = 192,
    EVT_WATER_SOLENOID_TEMPERATURE_CHANGE_UPDATE = 193,
    # /* --------- EEPROM Events ------------------------------- */
    EVT_E2_DOOR_COUNT_SAVE = 194,
    EVT_E2_PERSONALITY_SAVE = 195,
    EVT_E2_DEFROST_DATA_SAVE = 196,
    EVT_E2_FINISH_CONTROL_UPDATE = 197,
    EVT_E2_BROWNOUT_DATA_SAVE = 198,

    # /* --------- Mode Events ------------------------------- */
    EVT_DEFROST_SAVE = 199,
    EVT_CYCLE_SAVE = 200,
    EVT_CYCLE_SAVE_SECONDARY = 201,
    EVT_MANUAL_MODE_ON = 202,
    EVT_MANUAL_MODE_OFF = 203,
    # /* --------- I2c expander ao events---------------------- */
    EVT_I2C_WRITE_COMPLETE = 204,
    EVT_I2C_WRITE_OP_TIMEOUT = 205,
    EVT_I2C_READ_COMPLETE = 206,
    EVT_I2C_READ_OP_TIMEOUT = 207,
    EVT_I2C_PERIODIC_READ = 208,
    EVT_I2C_RETRY_WRITE = 209,
    EVT_I2C_SEQ_SWITCHING_READ_STATE = 210,
    EVT_I2C_SAFE_SEQ_SWITCHING_TIMER_EXPIRED = 211,
    EVT_I2C_SET_PIN_DATA = 212,
    EVT_I2C_AC_VALVE_EVT_PAIR_WAIT_TIMER_EXPIRED = 213,
    # /* --------- Connected Events --------------------------- */
    EVT_CONNECTED_CMD = 214,
    EVT_CONNECTED_ACK_RECEIVED = 215,
    EVT_CONNECTED_SEND_MSG = 216,
    EVT_CONNECTED_CHANGE_TEMP_UNIT = 217,
    EVT_CONNECTED_JUMP_TO_RESET = 218,
    EVT_CONNECTED_JUMP_TO_BOOTLOADER = 219,
    EVT_CONNECTED_ICE_ON = 220,
    EVT_CONNECTED_ICE_BOOST = 221,
    EVT_CONNECTED_REFRESH_ERDS_AFTER_PERS_HANDSHAKE = 222,
    EVT_WIFI_STATUS_UPDATE = 223,
    EVT_REQUEST_WIFI_STATUS_UPDATE = 224,
    EVT_DELAY_STARTING_PERIODIC_STATUS_ERD_REFRESH = 225,
    EVT_WIFI_SW_VER_RQ = 226,
    EVT_COMM_BUSY_TIME_OUT = 227,
    # /* --------- GEA raw data Events --------------------------- */
    EVT_GEA_RAW_DATA = 228,
    # /* --------- Misc Events -------------------------------- */
    EVT_FAULT = 229,
    EVT_RESCIND_FAULT = 230,
    EVT_VALVE_IN_POS = 231,
    EVT_SET_VALVE_POS = 232,
    EVT_DISABLE = 233,
    EVT_ENABLE = 234,
    EVT_VALVE_PURGE_TIMEOUT = 235,
    EVT_SHABBATH_MODE_STARTUP = 236,
    EVT_MANUAL_VALVE_TIMEOUT = 237,
    EVT_I_SENSE_1_HR = 238,
    EVT_DOOR_ALARM_MUTE_DELAYED = 239,
    EVT_RETRY_COMMS_BUS_ACCESS_TIMER = 240,
    EVT_SUSPEND_PERIPH = 241,
    EVT_STEPPER_DELAY_ON = 242,
    EVT_STEPPER_DELAY_OFF = 243,
...
integrated60ControllerTxEventAckOrNotAckDict = {
    ...
    Integrated60EventFromController.EVT_MANUAL_VALVE_INPOS          :         CommLonCmds.Acked,    
...
integrated60ControllerStaticEventSet = {
    # If need to update please refer to Controller repo -> StaticEvt.c 
    Integrated60EventFromController.EVT_AUDIO_OFF,
    Integrated60EventFromController.EVT_AUDIO_DONE,
    Integrated60EventFromController.EVT_AUDIO_DISABLE,
    Integrated60EventFromController.EVT_AUDIO_ENABLE,
